...
CurrentCost128XMLBaseStation = (function(_super) {
  ...
  function CurrentCost128XMLBaseStation(device, _arg) {
    ...
    if ((_ref3 = this.spikeThreshold) == null) {
    ...
    this.parser.onclosetag = function(tagName) {
      var avg, avgSecs, consumed, curDelta, curNow, doSpike, impPerInterval, oldRead, tot, _base, _name, _ref6, _s;
      ...
      if (tagName === 'ipu') {
        if (_s.inREALTIME) {
          ...
          if (_s.impStart[_s.sensor] == null) {
            ...
            if ((_ref6 = (_base = self.reading)[_name = _s.sensor]) == null) {
              _base[_name] = 0;
            }
            ...
            if (self.debug) {
              console.log("consumed:", consumed, _s.imp, _s.impStart[_s.sensor], " reading:", self.reading[_s.sensor]);
            }
            doSpike = false;
